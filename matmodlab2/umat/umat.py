...
try:
    ...
    raise SystemExit('umat module must first be built')
...
class UMat(Material):
    ...
    def sdvini(self, statev):
        ...
        lib.sdvini(statev, coords, noel, npt, layer, kspt,
                   logger.info, logger.warning, StopFortran)
        return statev
    ...
    def eval(self, time, dtime, temp, dtemp, F0, F,
        ...
        lib.umat(stress, statev, ddsdde,
            ...
            logger.info, logger.warn, StopFortran)
