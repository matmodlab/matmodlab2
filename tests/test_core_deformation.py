...
deformation_measures_db = [
    ...
    },
    {
        ...
        "eps": np.array(
            [
                0.026196877156206737235,
                0.016660265700936119908,
                0,
                0.020891312403896220150,
                0,
                0,
            ]
        ),
        "depsdt": np.array(
            [
                -0.0045059468741139683829,
                0.10450594687411396838,
                0,
                0.063726469853100399588,
                0,
                0,
            ]
        ),
        "subtests": [
            {
                ...
                "u": np.array(
                    [
                        1.0256583576911247384,
                        1.0163177868123306353,
                        1.0000000000000000000,
                        0.020461857461098139159,
                        0,
                        0,
                    ]
                ),
                "dudt": np.array(
                    [
                        -0.0056192451222061811013,
                        0.10159073211594549184,
                        0,
                        0.061454775148472809312,
                        0,
                        0,
                    ]
                ),
                "d": np.array(
                    [
                        -0.0066876940055755266344,
                        0.098792957163470263477,
                        0,
                        0.059274595960483676859,
                        0,
                        0,
                    ]
                ),
            },
            {
                ...
                "u": np.array(
                    [
                        1.0261968771562067372,
                        1.0166602657009361199,
                        1.0000000000000000000,
                        0.020891312403896220150,
                        0,
                        0,
                ...
                "d": np.array(
                    [
                        -0.0056693735828201687630,
                        0.10155978454172427835,
                        0,
                        0.061415383576480024658,
                        0,
                        0,
                    ]
                ),
            },
            {
                ...
                "u": np.array(
                    [
                        1.0267663449262200007,
                        1.0170224265913341846,
                        1.0000000000000000000,
                        0.021345447796308002806,
                        0,
                        0,
                    ]
                ),
                "dudt": np.array(
                    [
                        -0.0032560207940279426371,
                        0.10763489794578336117,
                        0,
                        0.066186651517750065998,
                        0,
                        0,
                    ]
                ),
                "d": np.array(
                    [
                        -0.0045260401459293278687,
                        0.10452604014592932787,
                        0,
                        0.063731056011271402912,
                        0,
                        0,
                    ]
                ),
            },
            {
                ...
                "u": np.array(
                    [
                        1.0273698716557383822,
                        1.0174062477472466924,
                        1.0000000000000000000,
                        0.021826744302578140456,
                        0,
                        0,
                    ]
                ),
                "dudt": np.array(
                    [
                        -0.0018481668596687927090,
                        0.11100388082714484528,
                        0,
                        0.068860299997538432155,
                        0,
                        0,
                    ]
                ),
                "d": np.array(
                    [
                        -0.0032383326989564664762,
                        0.10771594463925497394,
                        0,
                        0.066244519079865882721,
                        0,
                        0,
                    ]
                ),
            },
            {
                ...
                "u": np.array(
                    [
                        1.0280110311733133167,
                        1.0178140019942811183,
                        1.0000000000000000000,
                        0.022338051955872830687,
                        0,
                        0,
                    ]
                ),
                "dudt": np.array(
                    [
                        -0.00025673980976010909772,
                        0.11464385281246575042,
                        0,
                        0.071777050608761226760,
                        0,
                        0,
                    ]
                ),
                "d": np.array(
                    [
                        -0.0017829682784827673453,
                        0.11115796827848276735,
                        0,
                        0.068982906840537447349,
                        0,
                        0,
                    ]
                ),
...
@pytest.mark.parametrize("a", np.linspace(0.0, 1.0e1, 10))
@pytest.mark.parametrize("t", np.linspace(0.0, 1.0e1, 10))
...
def test_deformation_measures_from_strain_dissertation_static():
    ...
    # Setup (inputs)
    eps = np.array(
        [2.6634453918413015230, 0.13875241035650067478, 0, 0.60791403008229297100, 0, 0]
    )
    depsdt = np.array(
        [-0.66687706806142212351, 1.9745693757537298158, 0, 4.2494716756395844993, 0, 0]
    )

    # Setup (expected outputs)
    d_g = np.array(
        [-4.3525785227788080461, 5.6602708304711157384, 0, 11.902909607738023219, 0, 0]
    )
...
def test_scalar_volume_strain_to_tensor():
    ...
    kappa = 1
    e = df.scalar_volume_strain_to_tensor(ev, kappa)
    eij = ((kappa * ev + 1.0) ** (1.0 / 3.0) - 1.0) / kappa
