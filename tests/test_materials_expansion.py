...
@pytest.mark.parametrize("itemp", np.random.uniform(0.0, 100.0, 1))
@pytest.mark.parametrize("dtemp", np.random.uniform(10.0, 50.0, 1))
...
def test_expansion(itemp, dtemp, alpha):
    ...
    mps.run_step("ESS", (0.01, 0, 0), temperature=temp[0], frames=20)
